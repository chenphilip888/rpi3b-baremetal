...
#define PCM_CS_A            (volatile unsigned int *)(PBASE+0x00203000)
#define PCM_FIFO_A          (volatile unsigned int *)(PBASE+0x00203004)
#define PCM_MODE_A          (volatile unsigned int *)(PBASE+0x00203008)
#define PCM_RXC_A           (volatile unsigned int *)(PBASE+0x0020300c)
#define PCM_TXC_A           (volatile unsigned int *)(PBASE+0x00203010)
#define PCM_DREQ_A          (volatile unsigned int *)(PBASE+0x00203014)
#define PCM_INTEN_A         (volatile unsigned int *)(PBASE+0x00203018)
#define PCM_INTSTC_A        (volatile unsigned int *)(PBASE+0x0020301c)
#define PCM_GRAY            (volatile unsigned int *)(PBASE+0x00203020)
